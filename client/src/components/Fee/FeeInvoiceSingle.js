...
const FeeInvoiceSingle = ({ feeDetails }) => {
          ...
          {page.map((feeDetail, pageIndex) => (
            <View style={styles.column} key={pageIndex}>
              <View style={styles.headerContainer}>
                ...
                <Text style={styles.header}>Falah Institute Of Nursing <br/>& Allied Health Sciences</Text>
              </View>
              ...
              <View style={styles.table}>
                ...
                <View style={styles.tableRow}>
                  <Text style={styles.tableCell}>Programe:</Text>
              ...
              <View style={styles.table}>
                ...
                {feeDetail.arrears > 0 && (
                  <View style={styles.tableRow}>
                    ...
                    <Text style={styles.tableCell}>Rs. {feeDetail.arrears}/-</Text>
                  </View>
                )}
                <View style={styles.tableRow}>
              ...
              <View style={styles.line} />
                <Text>UBL, Secretariat Branch, Islamabad</Text>
                <Text>Account No: 306019641</Text>
              </View>
            </View>
          ))}
...
export default FeeInvoiceSingle;
