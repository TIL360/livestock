...
const FeeDetail = () => { 
    ...
    const handleConfirm = async () => {
        await handleInsertFees(); // Call the insert fees function
        ...
        <div className="container" style={{ background: "white" }}> 
            ...
            <div className="card-body"> 
                ...
                <div className="row mb-3 align-items-center"> 
                    ...
                    <div className="col-md-3"> 
                        <button className="btn btn-primary btn-sm mb-1 shadow p-2 rounded" onClick={handleFetchData}> Go </button> 
                    </div> 
                </div> 
                <div> 
                    <button className="btn btn-primary btn-sm mb-1 shadow p-2 rounded" onClick={confirmGenerateInvoices}> 
                    ...
                    <PDFDownloadLink document={<FeePdf feeDetails={filteredInvdetails} />} fileName="fee_report.pdf"> 
                        <button className="btn btn-warning ml-1 btn-sm mb-1 shadow p-2 rounded"> Download Report </button> 
                    </PDFDownloadLink> 
                ...
                <div className="pagination"> 
                    {Array.from({ length: totalPages }, (_, index) => ( 
                        <button key={index + 1} className={`btn ${currentPage === index + 1 ? "btn-success" : "btn-primary"}`} onClick={() => handlePageChange(index + 1)}> 
                            {index + 1} 
                        </button> 
                    ))} 
                </div> 
